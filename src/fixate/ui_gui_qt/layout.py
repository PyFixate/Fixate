...
class Ui_FixateUI(object):
    def setupUi(self, FixateUI):
        ...
        FixateUI.resize(850, 850)
        FixateUI.setMinimumSize(QtCore.QSize(850, 850))
        ...
        self.ActiveTest.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        ...
        self.MainLayout.addWidget(self.ActiveTest)
        ...
        self.TestDescription.setMinimumSize(QtCore.QSize(0, 40))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.MainLayout.addWidget(self.TestDescription)
        ...
        self.ButtonPanelLayout.setContentsMargins(-1, 9, -1, -1)
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.Active)
        ...
        self.gridLayout_3.addWidget(self.ActiveEvent, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.Events, 0, 0, 1, 1)
        ...
        self.gridLayout_4 = QtWidgets.QGridLayout(self.ErrorLog)
