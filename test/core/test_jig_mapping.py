...
class TestRelayMuxClearingTime(TestCase):
    ...
    # print("Setting an existing mux value mux 1")
    # jig.mux.Mux2("")
    # print("Setting Mux2 4")
    # jig.mux.Mux2("4")
    # print(jig.active_pins())
    # print("Setting Mux3 7")
    # jig.mux.Mux3("7")
    # print(jig.active_pins())
    # print("Setting Mux3 8")
    # jig.mux.Mux3("8")
    # print(jig.active_pins())
    # print("Setting Mux1 1")
    # jig.mux.Mux1("1")
    # print(jig.active_pins())
    # print("Setting Mux1 2")
    # jig.mux.Mux1("2")
    # print(jig.active_pins())
    # print("Setting Mux1 1 update false")
    # jig.mux.Mux1("1", trigger_update=False)
    # print(jig.active_pins())
    # print("Setting Mux3 8 update false")
    # jig.mux.Mux3("8", trigger_update=False)
    # print(jig.active_pins())
    # print("Setting Mux2 4 update all")
    # jig.mux.Mux2("4")
    # print(jig.active_pins())
    # print("Setting Mux2 5")
    # jig.mux.Mux2("5")
    # print(jig.active_pins())
