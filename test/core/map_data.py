...
MuxDmmInputHi_signal_map = [('0b00000000000001', 'SPARE14'),
...
class MuxDmmInputHi(VirtualMux):
    ...
    pin_list = [
        "DMM_HI5", "DMM_HI4", "DMM_HI3", "DMM_HI2", "DMM_HI1",  # Main DMM Hi Relays
        "P0.21", "P0.20", "P0.19",  # MuxC
        "P0.18", "P0.17", "P0.16",  # MuxB
        "P0.15", "P0.14", "P0.13",  # MuxA
    ]

    def map_signals(self):
        self.map_shifted(base_index=0, start_index=self.pin_list.index("DMM_HI5"),
                         values=[None, "SPARE14", "SPARE13", "SPARE12", "SPARE11", "CLK_CHK",
                                 None,  # Overridden later
                                 "SUPP_CT_POS", "SUPP_AC_POS", "SUPP_DC_POS", "SPARE10", "SUPP_110VAC", "PWR_VPS",
                                 "PWR_VREF", "PWR_EL_IN", "PWR_CAP", "PWR_REG_FB", "PWR_VDC", "PWR_SNUBBER_OUT",
                                 "CPU_4_20_MA_NEG", "CPU_VREF_POS", "CPU_EL_SIGNAL", "CPU_VPS_POS", "CPU_VLED",
                                 "CPU_R_A_RST",
                                 None,  # Overridden later
                                 None,  # Overridden later
                                 "CPU_SWCLK_NOT", "CPU_VCC", "CPU_VPS_2", "CPU_3_3_2_V", "SPARE9"])
        # Mux C
        self.map_shifted(base_index=6, start_index=self.pin_list.index("P0.21"),
                         values=["LED_0V_PS2", "LED_0V_PS1", "LED_VPS_POS", "LED_RELAY_DRIVE", "LED_RELAY_FEEDBACK",
                                 "LED_VREF", "LED_EL_SIGNAL", "MUX_C_GND"])
        # Mux B
        self.map_shifted(base_index=25, start_index=self.pin_list.index("P0.18"),
                         values=["CPU_RELAY_FEEDBACK", "CPU_RST_POS", "CPU_RST_NEG", "CPU_FS_POS", "CPU_FS_NEG",
                                 "CPU_MODE_3", "CPU_MODE_2", "CPU_MODE_1"])
        # Mux A
        self.map_shifted(base_index=26, start_index=self.pin_list.index("P0.15"),
                         values=["CPU_ISP_NOT", "CPU_SWDIO", "CPU_WDI", "TP4", "CPU_LED_CLK_5V", "CPU_LED_EN_5V",
                                 "CPU_LED_DATA_5V", "CPU_RELAY_DRIVE"])
...
class MuxDmmInputHi_treedef_compact(VirtualMux):
    ...
    mux_c = (
        "LED_0V_PS2", "LED_0V_PS1", "LED_VPS_POS", "LED_RELAY_DRIVE",
        "LED_RELAY_FEEDBACK", "LED_VREF", "LED_EL_SIGNAL", "MUX_C_GND")
    mux_b = (
        "CPU_RELAY_FEEDBACK", "CPU_RST_POS", "CPU_RST_NEG", "CPU_FS_POS",
        "CPU_FS_NEG", "CPU_MODE_3", "CPU_MODE_2", "CPU_MODE_1")
    mux_a = (
        "CPU_ISP_NOT", "CPU_SWDIO", "CPU_WDI", "TP4",
        "CPU_LED_CLK_5V", "CPU_LED_EN_5V", "CPU_LED_DATA_5V", "CPU_RELAY_DRIVE")
    map_tree = (
        None, "SPARE14", "SPARE13", "SPARE12",
        "SPARE11", "CLK_CHK", mux_c, "SUPP_CT_POS",
        "SUPP_AC_POS", "SUPP_DC_POS", "SPARE10", "SUPP_110VAC",
        "PWR_VPS", "PWR_VREF", "PWR_EL_IN", "PWR_CAP",
        "PWR_REG_FB", "PWR_VDC", "PWR_SNUBBER_OUT", "CPU_4_20_MA_NEG",
        "CPU_VREF_POS", "CPU_EL_SIGNAL", "CPU_VPS_POS", "CPU_VLED",
        "CPU_R_A_RST", shift_nested(mux_b, [3]), shift_nested(mux_a, [3, 3]), "CPU_SWCLK_NOT",
        "CPU_VCC", "CPU_VPS_2", "CPU_3_3_2_V", "SPARE9"
    )


MuxDisplayLEDs_signal_map = [('0b000010111', 'LED_10_PC'),
...
class MuxDisplayLEDs(VirtualMux):
    ...
    """
    pin_list = ["DispQ7", "DispQ6", "DispQ5", "DispQ4", "DispQ3", "DispQ2", "DispQ1", "DispQ0", "P0.0"]

    # pin_list = ["DispQ0", "DispQ1", "DispQ2", "DispQ3", "DispQ4", "DispQ5", "DispQ6", "DispQ7", "P0.0"]

    def map_signals(self):
        self.map_single("LED_10_PC", "DispQ3", "DispQ7", "DispQ6", "DispQ5")  # D5 LED 10%
        self.map_single("LED_20_PC", "DispQ3", "DispQ7", "DispQ6", "DispQ4")  # D6 LED 20%
        self.map_single("LED_30_PC", "DispQ3", "DispQ7", "DispQ4", "DispQ5")  # D8 LED 30%
        self.map_single("LED_40_PC", "DispQ3", "DispQ4", "DispQ6", "DispQ5")  # D9 LED 40%
        self.map_single("LED_50_PC", "DispQ2", "DispQ7", "DispQ6", "DispQ5")  # D10 LED 50%
        self.map_single("LED_60_PC", "DispQ2", "DispQ7", "DispQ6", "DispQ4")  # D11 LED 60%
        self.map_single("LED_70_PC", "DispQ2", "DispQ7", "DispQ4", "DispQ5")  # D13 LED 70%
        self.map_single("LED_80_PC", "DispQ2", "DispQ4", "DispQ6", "DispQ5")  # D14 LED 80%
        self.map_single("LED_90_PC", "DispQ1", "DispQ7", "DispQ6", "DispQ5")  # D16 LED 90%
        self.map_single("LED_100_PC", "DispQ1", "DispQ7", "DispQ6", "DispQ4")  # D18 LED 100%
        self.map_single("LED_CT_Fault", "DispQ1", "DispQ7", "DispQ4", "DispQ5")  # D23 LED CT Fault
        self.map_single("LED_HRM_Trip", "DispQ1", "DispQ4", "DispQ6", "DispQ5")  # D24 LED HRM Trip
        self.map_single("LED_Trip", "DispQ0", "DispQ7", "DispQ6", "DispQ5")  # D20 LED Trip
        self.map_single("LED_Healthy", "DispQ0", "DispQ7", "DispQ6", "DispQ4")  # D15 LED Healthy
        self.map_single("LED_NFS", "DispQ0", "DispQ4", "DispQ6", "DispQ5")  # D25 LED NFS
